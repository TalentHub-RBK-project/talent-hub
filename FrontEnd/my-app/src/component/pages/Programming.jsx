...
import CodingIcon from '../../image/coding.gif'
...
const Programming = (props) => {
  const progTalents = props.talents.filter((elem)=>{
    return elem.category === 'Programming & Tech'
  })
const navigate = useNavigate()
  return (
    <div className='container-prog'>
      <div className="title flex items-center justify-center gap-2 mt-10 ml-6">
        <img src={CodingIcon} className='h-20'></img>
        <h1 className='text-3xl font-bold text-[#181818]'>Programming & Tech</h1>
      </div>
